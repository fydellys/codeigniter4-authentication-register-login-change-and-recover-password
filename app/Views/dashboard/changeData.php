                ...
                <div class="card">
                    <div class="card-body">
                        <div class="m-sm-4">
                            ...
                            <form action="<?= base_url('dashboard/change-data') ?>"  method="post" enctype="multipart/form-data">

                            <div class="form-group">
                                <label>E-mail</label>
                                <input type="text" class="form-control" value="<?= set_value('email', $email) ?>" placeholder="" disabled>
                            </div>

                            <div class="form-group">
                                <label>Nome</label>
                                <input type="text" class="form-control" name="name" id="name" value="<?= set_value('name', $name) ?>" placeholder="">
                            </div>
